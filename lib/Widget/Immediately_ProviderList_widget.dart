...
class Immediately_ProviderList_widget extends StatefulWidget {
  final String Img;
  ...
  Immediately_ProviderList_widget({
    Key? key,
    required this.Img,
  ...
  @override
  State<Immediately_ProviderList_widget> createState() => _Immediately_ProviderList_widgetState();
}

class _Immediately_ProviderList_widgetState extends State<Immediately_ProviderList_widget> {
  @override
