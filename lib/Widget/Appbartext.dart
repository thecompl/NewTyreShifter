...
class Appbartext extends StatefulWidget {
  ...
  Appbartext({
    Key? key, required this.title,  this.icon=0, this.show_icon=0, this.elevation=1.0, this.height=40.0, this.colors=color.white, this.ontap, this.show_arrow_icon=0, this.showbottom=false, this.showtext=false, this.appbartxtstyle, this.appbartxt,
              ...
              children: [
                ...
                widget.show_icon == 1
                  ...
                  child:Container(
                    ...
                    width: 40,
                    child:widget.showtext! ==false ? Icon(
                      widget.icon,
                      color: color.black,
                    ):Textfield().text(widget.appbartxt, widget.appbartxtstyle),
                  ),)
                    : Container(width: 40,)
              ],
            ),
            Platform.isIOS?
            SizedBox(height: 5):SizedBox(height: 0)

          ],
        ),
      bottom:widget.showbottom! ? TabBar(
